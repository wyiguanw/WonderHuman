...
class ShapeDecoder(nn.Module):
    ...
    def __init__(self, in_size, hsize = 256, actv_fn='softplus'):
        ...
        # self.conv6NM = torch.nn.Conv1d(self.hsize, self.hsize, 1)
        # self.conv7NM = torch.nn.Conv1d(self.hsize, self.hsize, 1)
        self.conv8NM = torch.nn.Conv1d(self.hsize, 3, 1)
        ...
        # self.bn6NM = torch.nn.BatchNorm1d(self.hsize)
        # self.bn7NM = torch.nn.BatchNorm1d(self.hsize)
    ...
    def forward(self, x):
        ...
        # # normal pred
        # xNM6 = self.actv_fn(self.bn6NM(self.conv6NM(x5)))
        # xNM7 = self.actv_fn(self.bn7NM(self.conv7NM(xNM6)))
        xNM8 = self.conv8NM(xSH7)
        ...
        normal = self.sigmoid(xNM8)

        return x8, scales, shs, normal
